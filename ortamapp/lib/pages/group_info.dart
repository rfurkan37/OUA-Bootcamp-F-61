          ...
          IconButton(onPressed: (){
            showDialog(barrierDismissible: false, context: context, builder: (context){
              return AlertDialog(
                ...
                content: const Text("Gruptan çıkmak istediğinize emin misiniz ☹️"),
                actions: [
                  IconButton(onPressed: (){
              ...
              child: Row(
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text("Grup: ${widget.groupName}",style: const TextStyle(color: Colors.black, fontWeight: FontWeight.w500),),
        ...
        if(snapshot.hasData){
          if(snapshot.data['members'] != null){
            if(snapshot.data['members'].length != 0){
              ...
              return const Center(child: Text("ÜYELER YOK"),);
            }
          }
          else{
            return const Center(child: Text("ÜYELER YOK"),);
